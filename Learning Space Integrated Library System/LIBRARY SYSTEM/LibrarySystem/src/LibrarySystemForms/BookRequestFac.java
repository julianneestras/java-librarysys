...
public class BookRequestFac extends javax.swing.JFrame {


    public BookRequestFac() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookRequestFac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookRequestFac().setVisible(true);
            }
        });
    }
